<nav class="navbar bg-body-tertiary">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            <a href="/" class="btn btn-outline-success <?php echo e(request()->is('/') ? 'active' : ''); ?>"
                style="margin-right: 10pt">
                Home</a>
            <a href="<?php echo e(route('products.index')); ?>"
                class="btn btn-outline-success <?php echo e(request()->is('products') ? 'active' : ''); ?>"
                style="margin-right: 10pt">Product</a>
        </div>
        <a class="navbar-brand">Azzahra Rizki</a>
    </div>
</nav>
<?php /**PATH C:\Users\MIG12998\Herd\zahra\resources\views/components/nav-bar.blade.php ENDPATH**/ ?>